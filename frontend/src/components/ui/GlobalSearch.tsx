                    ...
                    {results.machines.map((m) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {m.active_items > 0 ? (
                            <Typography variant="caption" color="text.secondary" flexShrink={0}>{m.active_items} items active</Typography>
                          ) : null}
                        </Box>
                      );
                    })}
                    ...
                    {results.customers.map((c) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Typography variant="caption" color="text.secondary" flexShrink={0}>{c.items_in_storage} items in storage</Typography>
                        </Box>
                      );
                    })}
                  </Box>
                    ...
                    {results.locations.map((loc) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Typography variant="caption" color="text.secondary" flexShrink={0}>{loc.items_stored} items stored</Typography>
                        </Box>
                      );
                    })}
                  </Box>
