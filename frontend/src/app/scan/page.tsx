    ...
    try {
      ...
      setRackCells(
        rackDetail.data.shelves
          .filter((s) => Number(s.current_volume_m3) < Number(s.max_volume_m3))
          .map((s) => ({ id: s.id, row_number: s.row_number, column_number: s.column_number, max_volume_m3: Number(s.max_volume_m3) || 19.4, current_volume_m3: Number(s.current_volume_m3) || 0 }))
          );
    } catch {
      setRackCells([]);
    }
